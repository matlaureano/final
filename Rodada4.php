...
$selectdados = "SELECT rodada4,ativo_rodada4 FROM usuarios WHERE login ='$login'";
$select = mysqli_query($connect, $selectdados);
$verificadados = mysqli_fetch_array($select);
$rodada = $verificadados['rodada4'];
$ativo_rodada = $verificadados['ativo_rodada4'];
...
{ 
	...
	echo "<button type='submit' class='botao01'  value='4' name='AdicionarChute'>Adicionar Chute </button>";
}
if ($ativo_rodada == 2)
{

...
$selectdados = "SELECT ativo_rodada1 FROM usuarios WHERE login ='$login'";
$select = mysqli_query($connect, $selectdados);
$verificadados = mysqli_fetch_array($select);
$ativo_rodada = $verificadados['ativo_rodada1'];
...
{ 
	...
	echo "<br><br>";
	echo "<button type='submit' class='botao01'  value='1' name='AdicionarChute'>Adicionar Chute </button>";
	}
}
if ($ativo_rodada == 2)
{

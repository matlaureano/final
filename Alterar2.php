...
<body>
<form method="POST" action="AlterandoChute.php">
<br>
<center>
...
$selectdados = "SELECT ativo_rodada2 FROM usuarios WHERE login ='$login'";
$select = mysqli_query($connect, $selectdados);
$verificadados = mysqli_fetch_array($select);
$ativo_rodada = $verificadados['ativo_rodada2'];
...
{ 
	...
	echo "<br><br>";
	echo "<button type='submit' class='botao01'  value='2' name='AdicionarChute'>Adicionar Chute </button>";
	}
}
if ($ativo_rodada == 2)
{
